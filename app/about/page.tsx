  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Milestones in our mission to empower Hispanic professionals</p>
          </div>
      ...
      <section className="py-20 bg-teal-900 text-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Our Impact Today</h2>
            <p className="text-xl text-teal-100">Numbers that reflect our commitment to excellence</p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-orange-400 mb-2">
                <AnimatedCounter end={250} suffix="+" duration={3000} />
              </div>
              <div className="text-teal-100">CSUF Chapter Members</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-orange-400 mb-2">
                <AnimatedCounter end={85} suffix="%" duration={3000} />
              </div>
              <div className="text-teal-100">Industry Placement Rate</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-orange-400 mb-2">
                <AnimatedCounter end={150} prefix="$" suffix="K+" duration={3000} />
              </div>
              <div className="text-teal-100">Scholarships Awarded</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-orange-400 mb-2">
                <AnimatedCounter end={35} suffix="+" duration={3000} />
              </div>
              <div className="text-teal-100">Industry Partners</div>
            </div>
          </div>
        </div>
      </section>
